...
class GameUpdateApplierSpec extends Specification {
  ...
  "Should convert official state to player visible state" >> {
    ...
    result must be_==(Right(PlayerVisibleState(
      ...
      board = Map(
        Coordinate(0,0) -> MountainCell, Coordinate(1,0) -> EmptyCell(NormalCell), Coordinate(2,0) -> OccupiedCellState(Team(0), 1, CityCell), Coordinate(3,0) -> OccupiedCellState(Team(0), 25, GeneralCell),
        Coordinate(0,1) -> MountainCell, Coordinate(1,1) -> UnknownCell, Coordinate(2,1) -> EmptyCell(NormalCell), Coordinate(3,1) -> OccupiedCellState(Team(0), 1, NormalCell),
        Coordinate(0,2) -> UnknownCell, Coordinate(1,2) -> EmptyCell(CityCell), Coordinate(2,2) -> EmptyCell(NormalCell), Coordinate(3,2) -> EmptyCell(NormalCell),
        Coordinate(0,3) -> UnknownCell, Coordinate(1,3) -> EmptyCell(NormalCell), Coordinate(2,3) -> OccupiedCellState(Team(1), 25, GeneralCell), Coordinate(3,3) -> EmptyCell(NormalCell),
        Coordinate(0,4) -> EmptyCell(NormalCell), Coordinate(1,4) -> EmptyCell(NormalCell), Coordinate(2,4) -> EmptyCell(NormalCell), Coordinate(3,4) -> EmptyCell(NormalCell)
      ),
